...
* If you have group-based test-retest data then they recommend taking the difference between the test-retest outcomes and calculating the standard error as follows:

$SE.group = sd(differences) / sqrt(2)$

* If you have individual observations then they recommend calculating the standard error like this:
